...
printf "\e[1;93m  __    __ _           _                   \n"
printf " / / /\ \ \ |__   __ _| |_ ___ /\ /\ _ __  \n"
printf " \ \/  \/ / '_ \ / _' | __/ __/ / \ \ '_ \ \n"
printf "  \  /\  /| | | | (_| | |_\__ \ \_/ / |_) |\n"
printf "   \/  \/ |_| |_|\__,_|\__|___/\___/| .__/ \n"
printf "                                    |_|    \e[0m\n"
...
if [[ ! -d app/app/src/main/java/com/whatsup/ ]]; then
mkdir -p app/app/src/main/java/com/whatsup/
fi

printf "package com.whatsup;\n" > app/app/src/main/java/com/whatsup/MainActivity.java
